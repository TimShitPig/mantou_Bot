...
默认状态 = {"番茄": True, "七猫": True, "书旗": True, "QQ阅读": True, "QQ浏览器": True, "得间": True, "点众": True, "知乎": True, "塔读": True, "百度": True, "小米": True}
功能显示名 = {"番茄": "番茄小说", "七猫": "七猫小说", "书旗": "书旗小说", "QQ阅读": "QQ阅读", "QQ浏览器": "QQ浏览器小说", "得间": "得间小说", "点众": "点众小说", "知乎": "知乎", "塔读": "塔读小说", "百度": "百度小说", "小米": "小米小说"}
开关命令配置 = {
    "开启番茄": ("番茄", True),
    "关闭番茄": ("番茄", False),
    "开启七猫": ("七猫", True),
