...
帮助大类 = [
    {
        ...
        "小类": [
            ...
            },
            {
                "名称": "管理功能",
                "触发项": [
                    {"名称": "踢人", "触发": "@用户 踢 / @用户 踢了", "详情": "管理员可一次 @ 多个用户踢出，当前群成功后会跨群检查并踢出。"},
    ...
    },
    {
        ...
        "小类": [
            ...
            },
            {
                "名称": "群管功能",
                "触发项": [
                    {"名称": "数字撤回", "触发": "连续 9-12 位数字", "详情": "撤回当前消息并尝试撤回该用户最近消息；同一成员累计 3 次后跨群踢出。"},
                    {"名称": "卡片撤回", "触发": "群名片/JSON 卡片/群分享卡片", "详情": "自动撤回当前卡片消息，并尝试撤回该用户最近消息。"},
                    {"名称": "合并转发撤回", "触发": "合并转发/聊天记录", "详情": "自动撤回当前合并转发消息，并尝试撤回该用户最近消息。"},
                    {"名称": "QQ闪传撤回", "触发": "QQ闪传", "详情": "自动撤回当前 QQ 闪传消息，并尝试撤回该用户最近消息。"},
                ],
            },
        ],
    },
