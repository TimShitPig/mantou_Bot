        ...
        "小类": [
            ...
            },
            {
                ...
                "触发项": [
                    ...
                    {"名称": "查询卡密", "按钮data": "卡密查询", "触发": "查询卡密 -> 1/2/0 / 查询卡密 [使用/没使用/筛选] / 下一页 / 下 / 上一页 / 上 / 复制 [天数]", "详情": "查询卡密先选择已使用或未使用；已有查询结果时，发送 复制 输出全部卡密，发送 复制 30 只输出 30 天卡密。", "快捷命令": [{"data": "1", "label": "已使用"}, {"data": "2", "label": "未使用"}, "复制", "下一页", "上一页"]},
                ],
            },
        ],
    },
