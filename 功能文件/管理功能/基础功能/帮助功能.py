        ...
        "小类": [
            {
                ...
                "触发项": [
                    ...
                    {"名称": "QQ阅读", "触发": "QQ阅读详情/目录/分享链接", "详情": "识别 QQ阅读链接，直接使用本地参考项目的固定 App 身份、csigs 签名、动态密钥池和 Fetcher 下载正文；site=4 出版书同时解析 CTEB 与 EPUB 加密资源；完整合成 TXT 后上传 UC 网盘并发送“点击打开”按钮。"},
