        ...
        "小类": [
            {
                ...
                "触发项": [
                    ...
                    {
                        "名称": "小说开关",
                        "触发": "小说 / 小说列表 / 开小说 / 关小说 / 开番茄 / 开七猫 / 开书旗 / 开QQ阅读 / 开QQ浏览器 / 开得间 / 开点众 / 开知乎 / 开塔读 / 开百度 / 开小米 / 开宜搜 / 开米读 / 开猫眼 / 开酷我 / 开酷匠 / 开连城 / 开菠萝包 / 开晋江 / 关闭对应功能 / 开测试 / 关测试",
                    ...
                    {
                        "名称": "小说网盘",
                        "触发": "网盘 / 网盘状态 / 当前网盘 / 换UC / 换夸克 / 换百度 / 夸克登录 / 直接粘贴网盘 Cookie",
                        "详情": "查看或切换 UC、夸克和百度主分享网盘。白名单管理员可私聊发送「夸克登录」获取网页扫码二维码，扫码成功后自动把长期网页 Cookie 保存到 MySQL；也可直接粘贴普通 Cookie、Cookie 请求头、curl、Cookie Editor JSON 或 cookies.txt，新登录态覆盖旧值。",
                        "快捷命令": [
                            "网盘状态",
                            "夸克登录",
                            "换UC",
        ...
        "小类": [
            {
                ...
                "触发项": [
                    ...
                    {
                        "名称": "知乎",
                        "触发": "知乎 story 分享链接/分享卡片",
                        "详情": "识别 story.zhihu.com 的 paid_column 分享链接，先请求目录接口获取完整章节，再用章节详情补充书籍信息并发提取正文；失败章节单独重试，缺章不生成文件，完成后上传当前选择的小说网盘并发送“点击打开”按钮。",
                    },
                    {
                        "名称": "塔读小说",
                        "触发": "塔读链接/找书结果",
