        ...
        "小类": [
            {
                ...
                "触发项": [
                    ...
                    {"名称": "小说开关", "触发": "开启番茄 / 关闭番茄 / 开启七猫 / 关闭七猫 / 开启书旗 / 关闭书旗 / 开启QQ阅读 / 关闭QQ阅读 / 开启得间 / 关闭得间 / 开启点众 / 关闭点众", "详情": "管理员可开关小说功能里的番茄、七猫、书旗、QQ阅读、得间和点众下载功能。", "快捷命令": ["开启番茄", "关闭番茄", "开启七猫", "关闭七猫", "开启书旗", "关闭书旗", "开启QQ阅读", "关闭QQ阅读"]},
                    {"名称": "状态", "触发": "状态", "详情": "查看系统位数、CPU占用、物理内存、磁盘空间、系统进程、操作系统、框架版本、运行时间和当前时间。"},
        ...
        "小类": [
            {
                ...
                "触发项": [
                    ...
                    {"名称": "七猫小说", "触发": "七猫链接/七猫分享卡片", "详情": "识别七猫链接或分享卡片，下载完成后上传 UC 网盘并发送“点击打开”按钮。"},
                    {"名称": "书旗小说", "触发": "书旗链接/书旗分享卡片", "详情": "识别书旗长篇和短篇链接，优先使用批量接口并发下载；完成后上传 UC 网盘并发送“点击打开”按钮。"},
                    {"名称": "QQ阅读", "触发": "QQ阅读详情/目录链接 / 直接发送QQ阅读Cookie / QQ阅读cookie状态", "详情": "识别 QQ阅读链接，使用本地 App 批量下载与多模式解密；完成后上传 UC 网盘并发送“点击打开”按钮。群文件清理管理员白名单 QQ 可直接发送浏览器 Cookie、curl、Cookie Editor JSON 或 cookies.txt 保存登录态，状态不展示 Cookie 原文。"},
                    {"名称": "番茄小说", "触发": "番茄链接/番茄 JSON 分享卡片", "详情": "识别番茄链接或分享卡片，使用小说功能内置的番茄畅听下载逻辑；完成后上传 UC 网盘并发送“点击打开”按钮。"},
                    {"名称": "得间小说", "触发": "得间/掌阅链接", "详情": "识别得间/掌阅链接，使用本地 App 接口下载；完成后上传 UC 网盘并发送“点击打开”按钮。"},
                    {"名称": "点众小说", "触发": "点众链接", "详情": "识别点众链接，使用本地 App 接口下载（含广告解锁）；完成后上传 UC 网盘并发送“点击打开”按钮。"},
                ],
            },
            {
                "名称": "群管功能",
