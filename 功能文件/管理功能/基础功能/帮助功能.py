        ...
        "小类": [
            {
                "名称": "小说功能",
                "触发项": [
                    {"名称": "找书", "触发": "找关键词 / 找书 关键词 / 上一页 / 下一页", "详情": "聚合搜索番茄、七猫、书旗，同平台去重后按相关度与多平台共识排序，并按相似度聚拢，每页 5 条；不显示链接和来源；官方机器人书名和作者可点，点击后填入下载指令并发送；同书优先番茄>七猫>书旗。"},
                    ...
                    {"名称": "QQ阅读", "触发": "QQ阅读详情/目录链接", "详情": "识别 QQ阅读链接，使用本地 App 批量下载；完成后上传 UC 网盘并发送“点击打开”按钮。支持管理员登录QQ阅读。"},
