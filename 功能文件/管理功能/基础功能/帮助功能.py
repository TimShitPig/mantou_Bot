        ...
        "小类": [
            {
                "名称": "管理功能",
                "触发项": [
                    {"名称": "群禁言", "触发": "开启禁言 / 关闭禁言 / 禁全体 / 禁言全体 / 全体禁 / 全体禁言 / 解全体 / 解禁全体 / 全体解禁 / 全体解 / 禁言 @成员 / 禁 @成员 1 / 解 @成员", "详情": "管理员可开关当前群和全部群的全员禁言，也可按 @成员 设置禁言时长或解除单个成员禁言；禁言默认 7 天，不带单位的数字按天计算，支持秒、分、时和天。单成员禁言成功后会提及被禁言成员并提示联系群主。", "快捷命令": ["开启禁言", "关闭禁言", "禁全体", "全体禁言", "解全体", "全体解"]},
