        ...
        "小类": [
            {
                ...
                "触发项": [
                    ...
                    {
                        "名称": "小说开关",
                        "触发": "小说 / 小说列表 / 开小说 / 关小说 / 开番茄 / 开七猫 / 开书旗 / 开QQ阅读 / 开QQ浏览器 / 开得间 / 开点众 / 开盐言 / 开塔读 / 开百度 / 开小米 / 开宜搜 / 开米读 / 开猫眼 / 开酷我 / 开酷匠 / 开连城 / 开菠萝包 / 开晋江 / 关闭对应功能 / 开测试 / 关测试",
                ...
                "触发项": [
                    {
                        ...
                        "详情": "聚合搜索番茄、七猫、QQ阅读、QQ浏览器、书旗、得间、点众、塔读、百度小说、小米小说、宜搜、米读、猫眼、酷我、酷匠、连城、菠萝包和晋江；可自动识别或显式指定书名、作者，按匹配方式、实际匹配字数、覆盖率和跨平台共识排序，无关结果不展示；每页 5 条，不显示链接和来源。",
                    },
                    {
                        "名称": "七猫小说",
                        "触发": "七猫链接/七猫分享卡片",
