        ...
        "小类": [
            {
                "名称": "API功能",
                "触发项": [
                    {"名称": "随机英文单词", "触发": "随机英文单词", "详情": "返回单词、翻译、例句和译文。", "帮助别名": "帮助-单词"},
                    {"名称": "随机一言", "触发": "随机一言", "详情": "返回一言内容、出处和时间。", "帮助别名": "帮助-一言"},
                    {"名称": "疯狂星期四", "触发": "疯狂星期四", "详情": "返回随机 KFC 文案。", "帮助别名": "帮助-星期四"},
                    {"名称": "古诗词名句", "触发": "古诗词名句", "详情": "返回名句、作者和作品。", "帮助别名": "帮助-古诗词"},
                    {"名称": "番茄小说API切换", "触发": "查看API -> 1 / 2 / 3 或直接发送 oiapi / 析api / 崩溃api", "详情": "发送 查看API 后在 120 秒内发送 1/2/3 切换，或直接发送 oiapi/析api/崩溃api 快速切换。", "快捷命令": ["oiapi", "析api", "崩溃api"], "帮助别名": "帮助-API切换"},
                ],
            },
            {
                "名称": "管理功能",
                "触发项": [
                    {"名称": "踢人", "触发": "@用户 踢 / @用户 踢了", "详情": "管理员可一次 @ 多个用户踢出，当前群成功后会跨群检查并踢出；每个目标用户最多撤回最近 50 条消息。", "帮助别名": "帮助-踢人"},
                    {"名称": "全员禁言", "触发": "开启禁言 / 关闭禁言 / 开启全部禁言 / 关闭全部禁言", "详情": "管理员可开启或关闭当前群及机器人所在全部群的全员禁言。", "快捷命令": ["开启禁言", "关闭禁言", "开启全部禁言", "关闭全部禁言"], "帮助别名": "帮助-禁言"},
                    {"名称": "群文件清理", "触发": "清理群文件 / 群文件清理 / 清理全部群文件", "详情": "扫描并发删除当前群或机器人所在全部群的群文件。", "快捷命令": ["清理群文件", "清理全部群文件"], "帮助别名": "帮助-群文件"},
                    {"名称": "授权链接", "触发": "授权 / 授权 数字群号 / 授权 数字群号 机器人QQ", "详情": "生成 QQ 群服务授权链接。", "帮助别名": "帮助-授权"},
                    {"名称": "小说开关", "触发": "开启番茄 / 关闭番茄 / 开启七猫 / 关闭七猫", "详情": "管理员可开关番茄小说和七猫小说下载功能。", "快捷命令": ["开启番茄", "关闭番茄", "开启七猫", "关闭七猫"], "帮助别名": "帮助-小说开关"},
                    {"名称": "付费开关", "触发": "开启收费 / 关闭收费 / 开启群聊收费 / 关闭群聊收费 / 开启私聊收费 / 关闭私聊收费", "详情": "关闭收费让未单独设置开关的范围免费，已单独开启收费的群聊/私聊仍收费；开启收费强制全部收费。", "快捷命令": ["开启收费", "关闭收费", "开启群聊收费", "关闭群聊收费", "开启私聊收费", "关闭私聊收费"], "帮助别名": "帮助-付费开关"},
                    {"名称": "状态", "触发": "状态", "详情": "查看系统信息、插件版本、小说功能开关、当前番茄 API、收费开关和网盘启用状态。", "帮助别名": "帮助-状态"},
                    {"名称": "帮助", "触发": "帮助 / 帮助 数字 / 0", "详情": "查看帮助菜单，数字选择下一层，0 返回上一层。", "帮助别名": "帮助-帮助"},
                ],
            },
            {
                "名称": "用户激活",
                "触发项": [
                    {"名称": "激活用户", "触发": "@用户 激活 [天数] / 激活 用户QQ [天数]", "详情": "默认 30 天，支持一次操作多个 @ 或 QQ 号。", "帮助别名": "帮助-激活"},
                    {"名称": "重置用户", "触发": "@用户 重置 / 重置 用户QQ", "详情": "取消用户激活，支持批量。", "帮助别名": "帮助-重置"},
                    {"名称": "增加时间", "触发": "@用户 增加 天数 / 增加 用户QQ 天数", "详情": "在原到期时间基础上增加天数。", "帮助别名": "帮助-增加"},
                    {"名称": "减少时间", "触发": "@用户 减少 天数 / 减少 用户QQ 天数", "详情": "在原到期时间基础上减少天数，到期则取消激活。", "帮助别名": "帮助-减少"},
                    {"名称": "查询", "触发": "查询 / 查询 用户QQ / @用户 查询", "详情": "普通用户查自己，管理员可查指定用户；回复会显示 QQ、卡密、激活天数、剩余时间、激活时间和结束时间。", "帮助别名": "帮助-查询"},
                    {"名称": "查询用户", "触发": "查询用户 / 下一页 / 下 / 上一页 / 上", "详情": "分页查看当前群已激活用户，每页 10 条，按剩余时间从少到多显示 QQ、卡密和剩余时间。", "帮助别名": "帮助-查询用户"},
                    {"名称": "生成卡密", "触发": "生成卡密 [数量]", "详情": "生成 12 位一次性激活卡密，默认 1 个。", "帮助别名": "帮助-生成卡密"},
                    {"名称": "查询卡密", "触发": "查询卡密 -> 1/2/0 / 查询卡密 [使用/没使用/筛选] / 下一页 / 下 / 上一页 / 上 / 复制 [天数]", "详情": "查询卡密先选择已使用或未使用；已有查询结果时，发送 复制 输出全部卡密，发送 复制 30 只输出 30 天卡密。", "帮助别名": "帮助-查询卡密"},
                ],
            },
        ],
    },
        ...
        "小类": [
            {
                "名称": "小说功能",
                "触发项": [
                    {"名称": "七猫小说", "触发": "七猫链接/七猫分享卡片", "详情": "识别七猫链接或分享卡片，下载 txt 并发送。", "帮助别名": "帮助-七猫"},
                    {"名称": "番茄小说", "触发": "番茄链接/番茄 JSON 分享卡片", "详情": "识别番茄链接或分享卡片，按当前选择的 API 下载 txt 并发送。", "帮助别名": "帮助-番茄"},
                ],
            },
            {
                "名称": "群管功能",
                "触发项": [
                    {"名称": "数字撤回", "触发": "连续 9-12 位数字", "详情": "QQ群主和管理员不撤回；普通成员撤回当前消息并拉取 100 条群历史，最多撤回该用户最近 8 条消息；同一成员累计 3 次后跨群踢出。", "帮助别名": "帮助-数字撤回"},
                    {"名称": "卡片撤回", "触发": "群名片/JSON 卡片/群分享卡片", "详情": "QQ群主和管理员不撤回；普通成员自动撤回当前卡片消息，并最多撤回该用户最近 8 条消息。", "帮助别名": "帮助-卡片撤回"},
                    {"名称": "合并转发撤回", "触发": "合并转发/聊天记录", "详情": "QQ群主和管理员不撤回；普通成员自动撤回当前合并转发消息，并最多撤回该用户最近 8 条消息。", "帮助别名": "帮助-合并转发"},
                    {"名称": "QQ闪传撤回", "触发": "QQ闪传", "详情": "QQ群主和管理员不撤回；普通成员自动撤回当前 QQ 闪传消息，并最多撤回该用户最近 8 条消息。", "帮助别名": "帮助-闪传撤回"},
                ],
            },
        ],
    },
...
def 生成小类触发项键盘(大类序号: int, 小类序号: int, 自动发送: bool = False) -> dict[str, Any]:
    ...
    按钮列表 = []
    for 序号, 触发项 in enumerate(小类["触发项"], start=1):
        # 按钮 data 用帮助别名（避开真实命令字），没有别名则用数字
        别名 = 触发项.get("帮助别名")
        if 别名:
            按钮列表.append(生成按钮(别名, 触发项["名称"], 自动发送=自动发送))
        else:
            按钮列表.append(生成按钮(str(序号), 触发项["名称"], 自动发送=自动发送, data为标签=False))
    return {"rows": 按钮分行带返回(按钮列表, 生成返回按钮(自动发送))}
...
def 生成帮助详情键盘(触发项: dict[str, Any] | None = None, 自动发送: bool = False) -> dict[str, Any]:
    ...
    按钮列表 = [生成按钮(命令, 命令, 自动发送=自动发送) for 命令 in 快捷命令]
    返回按钮 = 生成返回按钮(自动发送)
...
def 匹配任意层级名称(文本: str) -> tuple[str, int, int | None, int | None] | None:
    ...
    触发项支持帮助别名匹配（按钮 data 用帮助别名避开真实命令字）"""
    ...
    for 大类序号, 大类 in enumerate(帮助大类):
        for 小类序号, 小类 in enumerate(大类["小类"]):
            for 触发项序号, 触发项 in enumerate(小类["触发项"]):
                if 触发项["名称"] == 文本 or 触发项.get("帮助别名") == 文本:
