        ...
        "小类": [
            ...
            },
            {
                ...
                "触发项": [
                    ...
                    {"名称": "用户列表", "触发": "查询用户 / 下一页 / 下 / 上一页 / 上", "详情": "分页查看当前群已激活用户，每页 10 条，按剩余时间从少到多显示 QQ、卡密和剩余时间。"},
                    {"名称": "生成卡密操作", "触发": "生成卡密 [数量]", "详情": "生成 12 位一次性激活卡密，默认 1 个。"},
                    {"名称": "查询卡密记录", "触发": "查询卡密 -> 1/2/0 / 查询卡密 [使用/没使用/筛选] / 下一页 / 下 / 上一页 / 上 / 复制 [天数]", "详情": "查询卡密先选择已使用或未使用；已有查询结果时，发送 复制 输出全部卡密，发送 复制 30 只输出 30 天卡密。"},
                ],
            },
        ],
    },
