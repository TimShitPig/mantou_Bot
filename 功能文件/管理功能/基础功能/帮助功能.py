        ...
        "小类": [
            {
                ...
                "触发项": [
                    ...
                    {"名称": "小说开关", "触发": "小说 / 小说列表 / 开小说 / 关小说 / 开番茄 / 开七猫 / 开书旗 / 开QQ阅读 / 开QQ浏览器 / 开得间 / 开点众 / 开知乎 / 开塔读 / 关闭对应功能 / 开测试 / 关测试", "详情": "发送「小说」或「小说列表」可查看全局小说功能和各平台状态。管理员发送「关小说」会关闭全部群聊的小说下载与找书；发送「开小说」只恢复全局开关，已单独关闭的平台继续关闭。管理员可用「开平台名」或「开启平台名」切换各平台下载功能。", "快捷命令": ["小说", "开小说", "关小说", "开番茄", "开七猫", "开书旗", "开QQ阅读", "开QQ浏览器", "开得间", "开点众", "开知乎", "开塔读", "开测试", "关测试"]},
