        ...
        "小类": [
            ...
            },
            {
                ...
                "触发项": [
                    ...
                    {"名称": "小说开关", "触发": "开启番茄 / 关闭番茄 / 开启七猫 / 关闭七猫 / 开启书旗 / 关闭书旗", "详情": "管理员可开关小说功能里的番茄小说、七猫小说和书旗小说下载功能。", "快捷命令": ["开启番茄", "关闭番茄", "开启七猫", "关闭七猫", "开启书旗", "关闭书旗"]},
                    ...
                    {"名称": "状态", "触发": "状态", "详情": "查看系统信息、插件版本、小说功能开关、番茄API开关、收费开关和网盘启用状态。"},
