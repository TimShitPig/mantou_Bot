        ...
        "小类": [
            ...
            },
            {
                ...
                "触发项": [
                    ...
                    {"名称": "群文件清理", "触发": "清理群文件 / 群文件清理 / 清理全部群文件", "详情": "扫描并发删除当前群或已添加目标群的群文件；清理全部群文件只清理「群聊管理」里添加的群。", "快捷命令": ["清理群文件", "清理全部群文件", "登录群文件"]},
                    {"名称": "群聊管理", "触发": "添加群聊 群号 / 删除群聊 群号 / 查看群聊", "详情": "维护待清理群文件的目标群列表，支持一次添加或删除多个群号；清理全部群文件时只清理这里添加的群。", "快捷命令": ["查看群聊"]},
