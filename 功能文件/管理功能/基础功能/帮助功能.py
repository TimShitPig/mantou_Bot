        ...
        "小类": [
            {
                ...
                "触发项": [
                    ...
                    {"名称": "番茄小说API切换", "触发": "查看API -> 1 / 2 / 3 / 4 / 5 或直接发送 oiapi / 析api / 崩溃api / 聚合api / y6api", "详情": "发送 查看API 后在 120 秒内发送 1/2/3/4/5 切换，或直接发送 oiapi/析api/崩溃api/聚合api/y6api 快速切换。", "快捷命令": ["oiapi", "析api", "崩溃api", "聚合api", "y6api"]},
                ],
            },
            {
                "名称": "管理功能",
                "触发项": [
                    {"名称": "踢人", "触发": "@用户 踢 / @用户 踢了 / @用户 踢人", "详情": "管理员可一次 @ 多个用户踢出，手动踢人不受开启/关闭踢人影响；当前群成功后会跨群检查并踢出；每个目标用户最多撤回最近 50 条消息。"},
                    {"名称": "全员禁言", "触发": "开启禁言 / 关闭禁言 / 开启全部禁言 / 关闭全部禁言", "详情": "管理员可开启或关闭当前群及机器人所在全部群的全员禁言。", "快捷命令": ["开启禁言", "关闭禁言", "开启全部禁言", "关闭全部禁言"]},
                    {"名称": "群文件清理", "触发": "登录群文件 / 群文件登录cookie / 群文件状态 / 清理群文件 / 群文件清理 / 清理全部群文件 / 添加群聊 群号 / 删除群聊 群号 / 删除群聊 / 查看群聊 / 更改备注 / 更改备注 群号", "详情": "通过 QQ 群文件网页接口删除群文件，需先「登录群文件」拿 Cookie；Cookie 支持浏览器 Cookie 头、curl、Cookie Editor JSON 和 cookies.txt，保存后默认每 1 小时自动保活；状态命令会显示群文件 Cookie/保活状态；清理群文件列出已添加群列表后点击群号按钮清理对应群（120秒有效，点返回上一步退出）；清理全部群文件清「添加群聊」添加的全部群；网页接口只删根目录文件，不递归子文件夹。", "快捷命令": ["登录群文件", "群文件状态", "清理群文件", "清理全部群文件", "查看群聊", "删除群聊", "更改备注"]},
                    {"名称": "踢人开关", "触发": "开启踢人 / 关闭踢人 / @用户 踢 / @用户 踢人", "详情": "开启踢人/关闭踢人只控制广告或数字撤回累计 3 次后的自动踢人，默认关闭；关闭时只撤回不提醒。手动 @用户 踢 或 @用户 踢人 不受开关影响，支持一次 @ 多个用户批量踢出。", "快捷命令": ["开启踢人", "关闭踢人"]},
                    {"名称": "授权链接", "触发": "授权 / 授权 数字群号 / 授权 数字群号 机器人QQ", "详情": "生成 QQ 群服务授权链接。"},
                    {"名称": "小说开关", "触发": "开启番茄 / 关闭番茄 / 开启七猫 / 关闭七猫 / 开启书旗 / 关闭书旗", "详情": "管理员可开关番茄小说、七猫小说和书旗小说下载功能。", "快捷命令": ["开启番茄", "关闭番茄", "开启七猫", "关闭七猫", "开启书旗", "关闭书旗"]},
            ...
            },
            {
                ...
                "触发项": [
                    ...
                    {"名称": "查询信息", "触发": "查询 / 查询 用户QQ / @用户 查询", "详情": "普通用户查自己，管理员可查指定用户；回复会显示 QQ、卡密、激活天数、剩余时间、激活时间和结束时间。"},
                    {"名称": "用户列表", "触发": "查询用户 / 下一页 / 下 / 上一页 / 上", "详情": "分页查看当前群已激活用户，每页 10 条，按剩余时间从少到多显示 QQ、卡密和剩余时间。", "快捷命令": ["下一页", "上一页"]},
                    {"名称": "卡密生成", "触发": "生成卡密 [数量]", "详情": "生成 12 位一次性激活卡密，默认 1 个。", "快捷命令": ["生成卡密 1", "生成卡密 5", "生成卡密 10", "生成卡密 20", "生成卡密 50", "生成卡密 100"]},
                    {"名称": "卡密查询", "触发": "查询卡密 -> 1/2/0 / 查询卡密 [使用/没使用/筛选] / 下一页 / 下 / 上一页 / 上 / 复制 [天数]", "详情": "查询卡密先选择已使用或未使用；已有查询结果时，发送 复制 输出全部卡密，发送 复制 30 只输出 30 天卡密。", "快捷命令": ["查询卡密 使用", "查询卡密 没使用", "复制"]},
                ],
            },
        ],
    },
