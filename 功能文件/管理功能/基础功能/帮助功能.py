        ...
        "小类": [
            ...
            },
            {
                ...
                "触发项": [
                    ...
                    {"名称": "付费开关", "触发": "开启收费 / 关闭收费 / 开启群聊收费 / 关闭群聊收费 / 开启私聊收费 / 关闭私聊收费", "详情": "当前版本已全部免费，收费开关指令仅提示无需开启/关闭。", "快捷命令": ["开启收费", "关闭收费"]},
        ...
        "小类": [
            {
                "名称": "小说功能",
                "触发项": [
                    {"名称": "找书", "触发": "找关键词 / 找书 关键词 / 上一页 / 下一页", "详情": "聚合搜索番茄、七猫、书旗，同平台去重后分页展示，每页 5 条，点击链接按现有流程下载。"},
