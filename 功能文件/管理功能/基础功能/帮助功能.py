        ...
        "小类": [
            {
                ...
                "触发项": [
                    ...
                    {"名称": "小说开关", "触发": "小说 / 小说列表 / 开小说 / 关小说 / 开番茄 / 开七猫 / 开书旗 / 开QQ阅读 / 开QQ浏览器 / 开得间 / 开点众 / 开知乎 / 开塔读 / 开百度 / 开小米 / 开宜搜 / 开米读 / 开猫眼 / 开酷我 / 开酷匠 / 开连城 / 开菠萝包 / 关闭对应功能 / 开测试 / 关测试", "详情": "发送「小说」或「小说列表」可查看全局小说功能和各平台状态。管理员发送「关小说」会关闭全部群聊的小说下载与找书；发送「开小说」只恢复全局开关，已单独关闭的平台继续关闭。管理员可用「开平台名」或「开启平台名」切换各平台下载功能。", "快捷命令": ["小说", "开小说", "关小说", "开番茄", "开七猫", "开书旗", "开QQ阅读", "开QQ浏览器", "开得间", "开点众", "开知乎", "开塔读", "开百度", "开小米", "开宜搜", "开米读", "开猫眼", "开酷我", "开酷匠", "开连城", "开菠萝包", "开测试", "关测试"]},
        ...
        "小类": [
            {
                "名称": "小说功能",
                "触发项": [
                    {"名称": "找书", "触发": "找关键词 / 找书 关键词 / 找书名 关键词 / 找作者 关键词 / 上一页 / 下一页", "详情": "聚合搜索番茄、七猫、QQ阅读、QQ浏览器、书旗、得间、点众、塔读、百度小说、小米小说、宜搜、米读、猫眼、酷我、酷匠、连城和菠萝包；可自动识别或显式指定书名、作者，按匹配方式、实际匹配字数、覆盖率和跨平台共识排序，无关结果不展示；每页 5 条，不显示链接和来源。"},
