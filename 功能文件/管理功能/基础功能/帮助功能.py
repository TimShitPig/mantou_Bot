        ...
        "小类": [
            {
                ...
                "触发项": [
                    ...
                    {"名称": "小说开关", "触发": "小说 / 小说列表 / 开番茄 / 开七猫 / 开书旗 / 开QQ阅读 / 开QQ浏览器 / 开得间 / 开点众 / 开知乎 / 开塔读 / 关闭对应功能 / 开测试 / 关测试", "详情": "发送「小说」或「小说列表」可查看全部小说功能的开启/关闭状态；管理员可用「开平台名」或「开启平台名」开启番茄、七猫、书旗、QQ阅读、QQ浏览器、得间、点众、知乎和塔读下载功能。开启管理员测试模式后，管理员可继续测试已关闭的小说平台，普通用户仍按平台开关处理。", "快捷命令": ["小说", "开番茄", "开七猫", "开书旗", "开QQ阅读", "开QQ浏览器", "开得间", "开点众", "开知乎", "开塔读", "开测试", "关测试"]},
        ...
        "小类": [
            {
                "名称": "小说功能",
                "触发项": [
                    {"名称": "找书", "触发": "找关键词 / 找书 关键词 / 找书名 关键词 / 找作者 关键词 / 上一页 / 下一页", "详情": "聚合搜索番茄、七猫、QQ阅读、QQ浏览器、书旗、得间、点众和塔读；可自动识别或显式指定书名、作者，按匹配方式、实际匹配字数、覆盖率和跨平台共识排序，无关结果不展示；每页 5 条，不显示链接和来源。"},
