        ...
        "小类": [
            {
                ...
                "触发项": [
                    ...
                    {
                        "名称": "小说网盘",
                        "触发": "网盘 / 网盘状态 / 当前网盘 / 换UC / 换夸克 / 换百度 / UC换N / 夸换N / 夸克换N / 百换N / 百度换N / 夸克登录 / 直接粘贴网盘 Cookie",
                        "详情": "查看或切换 UC、夸克和百度主分享网盘，并查看各平台账号数量。插件配置 Cookie 作为账号1，白名单管理员继续粘贴同平台 Cookie 会新增账号；在群内发送「UC换N」「夸换N」或「百度换N」只切换当前群对应平台账号，未设置时默认账号1，三个平台互不影响。白名单管理员可私聊发送「夸克登录」获取网页扫码二维码，扫码成功后保存为新的夸克账号；也可直接粘贴普通 Cookie、Cookie 请求头、curl、Cookie Editor JSON 或 cookies.txt。",
                        "快捷命令": [
                            "网盘状态",
                            "UC换2",
                            "夸换2",
