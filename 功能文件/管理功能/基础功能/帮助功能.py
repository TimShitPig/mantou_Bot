        ...
        "小类": [
            {
                ...
                "触发项": [
                    ...
                    {"名称": "番茄小说API切换", "触发": "查看API -> 1 / 2 / 3 / 4 或直接发送 oiapi / 析api / 崩溃api / 聚合api", "详情": "发送 查看API 后在 120 秒内发送 1/2/3/4 切换，或直接发送 oiapi/析api/崩溃api/聚合api 快速切换。", "快捷命令": ["oiapi", "析api", "崩溃api", "聚合api"]},
                ],
            },
            {
                "名称": "管理功能",
