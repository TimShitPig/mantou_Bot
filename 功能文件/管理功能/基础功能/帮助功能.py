        ...
        "小类": [
            {
                "名称": "管理功能",
                "触发项": [
                    {"名称": "群禁言", "触发": "开启禁言 / 关闭禁言 / 开启全员禁言 / 关闭全员禁言 / 开启全部禁言 / 关闭全部禁言 / 禁言 @成员 / 禁 @成员 1 / 解 @成员", "详情": "管理员可开启或关闭当前群及机器人所在全部群的全员禁言，也可按 @成员 设置禁言时长或解除单个成员禁言；禁言默认 7 天，不带单位的数字按天计算，支持秒、分、时和天。", "快捷命令": ["开启禁言", "关闭禁言", "开启全员禁言", "关闭全员禁言", "开启全部禁言", "关闭全部禁言"]},
    ...
    },
    {
        ...
        "小类": [
            ...
            },
            {
                "名称": "群管功能",
                "触发项": [
                    {"名称": "成员禁言", "触发": "禁言 @成员 / 禁 @成员 1 / 解除禁言 @成员 / 解 @成员", "详情": "管理员可按 @成员 设置禁言时长；禁言默认 7 天，不带单位的数字按天计算，支持秒、分、时和天，使用解除禁言或解立即解除。"},
