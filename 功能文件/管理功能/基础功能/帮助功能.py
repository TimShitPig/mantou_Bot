        ...
        "小类": [
            {
                ...
                "触发项": [
                    {
                        "名称": "群禁言",
                        "触发": "禁言 @成员 / 禁 @成员 1 / 解 @成员",
                        "详情": "管理员可按 @成员 设置禁言时长或解除单个成员禁言；禁言默认 7 天，不带单位的数字按天计算，支持秒、分、时和天。单成员禁言成功后会提及被禁言成员并提示联系群主。",
                        "快捷命令": ["禁言 @成员", "禁 @成员 1", "解 @成员"],
                    },
                    {
                        "名称": "广告拦截开关",
                        "触发": "开广告 / 关广告 / 广告状态",
                        "详情": "插件管理员可在 QQ 官方群内按群独立开启或关闭广告、卡片和数字消息的自动撤回；默认关闭，开启后只处理当前消息，状态保存到运行状态数据库。",

                        "快捷命令": ["开广告", "关广告", "广告状态"],
                    },
                    {
                        "名称": "小说开关",
                        "触发": "小说 / 小说列表 / 开小说 / 关小说 / 开番茄 / 开七猫 / 开书旗 / 开追书 / 开QQ阅读 / 开QQ浏览器 / 开得间 / 开点众 / 开盐言 / 开塔读 / 开百度 / 开小米 / 开宜搜 / 开米读 / 开猫眼 / 开酷我 / 开酷匠 / 开连城 / 开菠萝包 / 开晋江 / 关闭对应功能 / 开测试 / 关测试",
                        "详情": "发送「小说」或「小说列表」可查看全局小说功能和各平台状态。管理员发送「关小说」会关闭全部群聊的小说下载与找书；发送「开小说」只恢复全局开关，已单独关闭的平台继续关闭。管理员可用「开平台名」或「开启平台名」切换各平台下载功能。",
                        "快捷命令": [
                            "小说",
                            "开小说",
                            "关小说",
                    ...
                    {
                        "名称": "小说网盘",
                        "触发": "网盘 / 网盘状态 / 当前网盘 / 换UC / 换夸克 / 换百度 / UC换N / 夸换N / 夸克换N / 百换N / 百度换N / 夸克登录 / 添加夸克 / 夸克账号 / 删夸克N / 直接粘贴网盘 Cookie",
                        "详情": "查看或切换 UC、夸克和百度主分享网盘，并查看各平台账号数量。插件配置 Cookie 作为账号1，白名单管理员继续粘贴同平台 Cookie 会新增账号；在群内发送「UC换N」「夸换N」或「百度换N」只切换当前群对应平台账号，未设置时默认账号1，三个平台互不影响。白名单管理员可私聊发送「夸克登录」获取网页扫码二维码，扫码成功后保存为新的夸克账号；私聊发送「添加夸克」查看添加方式，发送「夸克账号」可查看夸克账号名称和脱敏手机号，发送「删夸克N」删除账号；也可直接粘贴普通 Cookie、Cookie 请求头、curl、Cookie Editor JSON 或 cookies.txt。",
                        "快捷命令": [
                            "网盘状态",
                            "UC换2",
                            "夸换2",
                    ...
                    {
                        "名称": "QQ阅读登录",
                        "触发": "直接发送含 ywguid / ywkey 的 Cookie",
                        "详情": "直接粘贴 QQ阅读 Cookie，无需命令前缀；支持普通 Cookie、ywkey/ywguid 冒号两行文本、Cookie 头、curl、Cookie Editor JSON 和 cookies.txt。有效登录态保存到 MySQL，新 Cookie 会覆盖旧登录态。",
                    },
                    {
                        "名称": "状态",
                        "触发": "状态",
                        "详情": "查看系统位数、CPU占用、物理内存、磁盘空间、系统进程、操作系统、框架版本、数据库状态、运行时间和当前时间；每次输入时检查一次数据库。",
                    },
                    {
                        "名称": "帮助",
                        "触发": "帮助 / 帮助 数字 / 0",
                        "详情": "查看帮助菜单，数字选择下一层，0 返回上一层。",
                    },
                ],
            },
        ],
        ...
        "小类": [
            {
                ...
                "触发项": [
                    {
                        "名称": "找书",
                        "触发": "找关键词 / 找书 关键词 / 找书名 关键词 / 找作者 关键词 / 上一页 / 下一页",
                        "详情": "聚合搜索番茄、七猫、QQ阅读、QQ浏览器、书旗、追书、得间、点众、塔读、百度小说、小米小说、宜搜、米读、猫眼、酷我、酷匠、连城、菠萝包和晋江；可自动识别或显式指定书名、作者，按匹配方式、实际匹配字数、覆盖率和跨平台共识排序，无关结果不展示；每页 5 条，不显示链接和来源。",
                    },
                    {
                        "名称": "七猫小说",
                        "触发": "七猫链接/七猫分享卡片",
                        "详情": "识别七猫链接或分享卡片，下载完成后上传当前选择的小说网盘并发送“点击打开”按钮。",
                    },
                    {
                        "名称": "书旗小说",
                        "触发": "书旗链接/书旗分享卡片",
                        "详情": "识别书旗长篇、短篇和短链；一次读取完整目录后按正文 URL 动态并发下载单章，仅重试失败章节，缺章时停止；完成后上传当前选择的小说网盘并发送“点击打开”按钮。",
                    },
                    {
                        "名称": "追书小说",
                        "触发": "追书神器链接/追书分享卡片",
                        "详情": "识别追书神器分享链接，自动建立游客会话并按目录逐章获取密钥与正文；复用异步 HTTP 会话，正文和密钥并发请求，完整合成 TXT 后上传当前选择的小说网盘并发送“点击打开”按钮。",
                    },
                    {
                        "名称": "QQ阅读",
                        "触发": "QQ阅读详情/目录/分享链接",
                        "详情": "识别 QQ阅读链接，使用 App 身份、csigs 签名、动态密钥池和 Fetcher 下载正文；数据库存在 QQ阅读登录态时以最新 Cookie 的 ywguid/ywkey 覆盖固定账号字段；site=4 出版书同时解析 CTEB 与 EPUB 加密资源；完整合成 TXT 后上传当前选择的小说网盘并发送“点击打开”按钮。",
                    },
                    {
                        "名称": "QQ浏览器小说",
                        "触发": "QQ浏览器小说链接 / qb://ext/novelreader 深链",
                        "详情": "使用 QQ 浏览器公开搜索、详情、目录和正文接口，按番茄格式生成完整 TXT；不包含 Cookie、EPUB、封面或独立上传功能。",
                    },
                    {
                        "名称": "番茄小说",
                        "触发": "番茄链接/番茄 JSON 分享卡片",
                        "详情": "识别番茄链接或分享卡片，使用小说功能内置的番茄畅听下载逻辑；完成后上传当前选择的小说网盘并发送“点击打开”按钮。",
                    },
                    {
                        "名称": "得间小说",
                        "触发": "得间/掌阅链接",
                        "详情": "识别得间/掌阅链接，使用本地 App 接口下载；完成后上传当前选择的小说网盘并发送“点击打开”按钮。",
                    },
                    {
                        "名称": "点众小说",
                        "触发": "点众链接",
                        "详情": "识别点众链接，使用本地 App 接口下载（含广告解锁）；完成后上传当前选择的小说网盘并发送“点击打开”按钮。",
                    },
                    {
                        "名称": "盐言小说",
                        "触发": "盐言 story 分享链接/分享卡片",
                        "详情": "识别 story.zhihu.com 的 paid_column 分享链接，只处理分享链接对应的当前章节；使用章节详情补充标题和作者，正文提取失败时仅重试当前章节，完成后上传当前选择的小说网盘并发送“点击打开”按钮。",
                    },
                    {
                        "名称": "塔读小说",
                        "触发": "塔读链接/找书结果",
                        "详情": "识别 reader.tadu.com 书籍链接和找书结果，使用塔读 App 接口获取详情、目录和 TDZ 正文；目录和正文通过异步 HTTP 连接复用，最高 400 路并发，内嵌加密与正文解析逻辑，缺章不生成部分 TXT，完成后上传当前选择的小说网盘并发送“点击打开”按钮。",
                    },
                    {
                        "名称": "百度小说",
                        "触发": "百度小说链接/百度小说分享卡片",
                        "详情": "识别百度小说链接或分享卡片，使用百度详情、目录和 AES 正文接口，按番茄格式生成完整 TXT；缺少任意章节时停止，完成后上传当前选择的小说网盘并发送“点击打开”按钮。",
                    },
                    {
                        "名称": "小米小说",
                        "触发": "小米小说链接/小米小说分享卡片",
                        "详情": "识别小米浏览器小说链接或分享卡片，使用详情、目录和正文接口，按番茄格式生成完整 TXT；缺少任意章节时停止，完成后上传当前选择的小说网盘并发送“点击打开”按钮。",
                    },
                    {
                        "名称": "宜搜小说",
                        "触发": "宜搜小说链接/分享卡片",
                        "详情": "识别宜搜链接或分享卡片，使用异步复用会话和库解密正文，按番茄格式生成完整 TXT；缺少任意章节时停止，完成后上传当前选择的小说网盘并发送“点击打开”按钮。",
                    },
                    {
                        "名称": "米读小说",
                        "触发": "米读小说链接/分享卡片",
                        "详情": "识别米读链接或分享卡片，使用异步复用会话读取详情、目录和正文，按番茄格式生成完整 TXT；缺少任意章节时停止，完成后上传当前选择的小说网盘并发送“点击打开”按钮。",
                    },
                    {
                        "名称": "猫眼小说",
                        "触发": "猫眼/掌阅链接",
                        "详情": "识别猫眼或掌阅链接，使用异步复用会话读取详情、目录和正文，按番茄格式生成完整 TXT；缺少任意章节时停止，完成后上传当前选择的小说网盘并发送“点击打开”按钮。",
                    },
                    {
                        "名称": "酷我小说",
                        "触发": "酷我小说链接/分享卡片",
                        "详情": "识别酷我链接，使用异步复用会话读取详情、目录和明文正文，按番茄格式生成完整 TXT；缺少任意章节时停止，完成后上传当前选择的小说网盘并发送“点击打开”按钮。",
                    },
                    {
                        "名称": "酷匠小说",
                        "触发": "酷匠小说链接/分享卡片",
                        "详情": "识别酷匠链接，使用异步复用会话和库解密正文，按番茄格式生成完整 TXT；缺少任意章节时停止，完成后上传当前选择的小说网盘并发送“点击打开”按钮。",
                    },
                    {
                        "名称": "连城小说",
                        "触发": "连城小说链接/分享卡片",
                        "详情": "识别连城链接，使用异步复用会话读取详情、目录和 HTML 正文，按番茄格式生成完整 TXT；缺少任意章节时停止，完成后上传当前选择的小说网盘并发送“点击打开”按钮。",
                    },
                    {
                        "名称": "菠萝包小说",
                        "触发": "菠萝包小说链接/分享卡片",
                        "详情": "识别菠萝包链接，使用异步复用会话读取详情、目录和明文正文，按番茄格式生成完整 TXT；缺少任意章节时停止，完成后上传当前选择的小说网盘并发送“点击打开”按钮。",
                    },
                    {
                        "名称": "晋江小说",
                        "触发": "晋江链接/分享卡片",
                        "详情": "识别晋江书籍链接或分享卡片，只下载接口确认可公开读取的章节；复用异步 HTTP 会话并发请求明文正文，付费章节不请求，缺少任意公开章节时不生成部分 TXT，完成后上传当前选择的小说网盘并发送“点击打开”按钮。",
                    },
                ],
            },
            {
                ...
                "触发项": [
                    {
                        "名称": "成员禁言",
                        "触发": "禁言 @成员 / 禁 @成员 1 / 解除禁言 @成员 / 解 @成员",
                        "详情": "管理员可按 @成员 设置禁言时长；禁言默认 7 天，不带单位的数字按天计算，支持秒、分、时和天，成功后会 @被禁言成员并提示联系群主，使用解除禁言或解立即解除。",
                    },
                    {
                        "名称": "数字撤回",
                        "触发": "连续 9-12 位数字",
                        "详情": "QQ群主和管理员不撤回；普通成员撤回当前消息并拉取 100 条群历史，最多撤回该用户最近 8 条消息。",
                    },
                    {
                        "名称": "卡片撤回",
                        "触发": "群名片/JSON 卡片/群分享卡片",
                        "详情": "QQ群主和管理员不撤回；普通成员自动撤回当前卡片消息，并最多撤回该用户最近 8 条消息；成功禁言后只发送一条发送者提醒。",
                    },
                    {
                        "名称": "合并转发撤回",
                        "触发": "合并转发/聊天记录",
                        "详情": "QQ群主和管理员不撤回；普通成员自动撤回当前合并转发消息，并最多撤回该用户最近 8 条消息；成功禁言后只发送一条发送者提醒。",
                    },
                    {
                        "名称": "QQ闪传撤回",
                        "触发": "QQ闪传",
                        "详情": "QQ群主和管理员不撤回；普通成员自动撤回当前 QQ 闪传消息，并最多撤回该用户最近 8 条消息；成功禁言后只发送一条发送者提醒。",
                    },
                ],
            },
        ],
...
def 处理帮助指令(event: Any, 命令文本: str, 配置: Any) -> str | None:
    ...
    if 帮助状态 is not None and (
        re.fullmatch(r"\d{1,2}", 文本) or 文本 in 返回上一步别名
    ):
        if not 是管理员:
...
def 获取有效帮助状态(会话键: str) -> dict[str, Any] | None:
    ...
    开始时间 = 帮助状态.get("时间")
    if (
        isinstance(开始时间, (int, float))
        and time.time() - 开始时间 <= 帮助选择等待秒数
    ):
        return 帮助状态
    待选择帮助会话.pop(会话键, None)
    return None
...
def 处理帮助数字选择(
    ...
    if (
        层级 in {"触发项", "详情"}
        and isinstance(大类序号, int)
        and isinstance(小类序号, int)
    ):
...
def 生成帮助返回回调按钮(自动发送: bool = False) -> dict[str, Any]:
    return 生成帮助回调按钮(
        "返回上一步", "返回上一步", "已返回", 自动发送, data为标签=False
    )


def 按钮分行(
    按钮列表: list[dict[str, Any]], 每行最多: int = 每行按钮数
) -> list[dict[str, Any]]:
    return [
        {"buttons": 按钮列表[开始 : 开始 + 每行最多]}
        for 开始 in range(0, len(按钮列表), 每行最多)
    ]


def 按钮分行带返回(
    按钮列表: list[dict[str, Any]], 返回按钮: dict[str, Any], 每行最多: int = 每行按钮数
) -> list[dict[str, Any]]:
    行 = 按钮分行(按钮列表, 每行最多)
...
def 生成小类键盘(大类序号: int, 自动发送: bool = False) -> dict[str, Any]:
    大类 = 帮助大类[大类序号]
    按钮列表 = [
        生成帮助回调按钮(小类["名称"], 小类["名称"], 自动发送=自动发送)
        for 小类 in 大类["小类"]
    ]
    return {"rows": 按钮分行带返回(按钮列表, 生成帮助返回回调按钮(自动发送))}
...
def 生成小类触发项键盘(
    大类序号: int, 小类序号: int, 自动发送: bool = False
) -> dict[str, Any]:
    小类 = 帮助大类[大类序号]["小类"][小类序号]
    ...
    for 触发项 in 小类["触发项"]:
        if 用按钮字:
            ...
            按钮列表.append(
                生成帮助回调按钮(
                    data值, 触发项["名称"], 自动发送=自动发送, data为标签=False
                )
            )
        elif 触发项.get("快捷命令"):
            按钮列表.append(
                生成帮助回调按钮(触发项["名称"], 触发项["名称"], 自动发送=自动发送)
            )
        else:
            按钮列表.append(
                生成帮助回调按钮(触发项["名称"], 触发项["名称"], 自动发送=自动发送)
...
def 生成帮助详情键盘(
    ...
    for 命令 in 快捷命令:
        if isinstance(命令, dict):
            ...
            静态按钮列表.append(
                生成帮助回调按钮(
                    data值, 标签, 自动发送=自动发送, data为标签=False, 快捷命令=True
                )
            )
        else:
            静态按钮列表.append(
                生成帮助回调按钮(命令, 命令, 自动发送=自动发送, 快捷命令=True)
            )
...
def 获取帮助键盘(
    会话键: str, 自动发送: bool = False, 配置: Any = None, 群号: str = ""
) -> dict[str, Any] | None:
    帮助状态 = 获取有效帮助状态(会话键)
    if 帮助状态 is None:
        return None
...
def 检查键盘行数(
    键盘: dict[str, Any], 大类序号: int, 小类序号: int | None
) -> dict[str, Any] | None:
    ...
    if 行数 > 5:
        位置 = (
            f"大类{大类序号 + 1}"
            if 小类序号 is None
            else f"大类{大类序号 + 1}小类{小类序号 + 1}"
        )
        logger.info(
            f"[帮助键盘] {位置} 按钮行数={行数} 超过 QQ 官方 5 行限制，降级为无按钮 markdown"
        )
        return None
    return 键盘
...
async def 发送Markdown键盘消息(
    ...
    *,
    ...
    if _http is None:
        logger.warning(
            f"[帮助MD键盘] 无法获取 _http，bot={type(bot).__name__ if bot else None}，api={type(api).__name__ if api else None}"
        )
        return False
