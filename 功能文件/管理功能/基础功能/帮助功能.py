        ...
        "小类": [
            {
                ...
                "触发项": [
                    ...
                    {"名称": "小说网盘", "触发": "网盘 / 网盘状态 / 当前网盘 / 换UC / 换夸克 / 换百度 / 直接粘贴网盘 Cookie", "详情": "查看或切换 UC、夸克和百度主分享网盘。白名单管理员可直接粘贴普通 Cookie、Cookie 请求头、curl、Cookie Editor JSON 或 cookies.txt；插件自动识别平台并保存到 MySQL，新 Cookie 覆盖旧登录态。识别不明确时可使用 UC Cookie:、夸克 Cookie:、百度 Cookie: 前缀。", "快捷命令": ["网盘状态", "换UC", "换夸克", "换百度"]},
