        ...
        "小类": [
            {
                ...
                "触发项": [
                    ...
                    {"名称": "QQ阅读", "触发": "QQ阅读详情/目录/content链接", "详情": "识别 QQ阅读链接；默认本地 App 5 批并发下载，开启QQ阅读API 后走析API；完成后上传 UC 网盘并发送“点击打开”按钮。支持管理员登录QQ阅读。"},
                    {"名称": "番茄小说", "触发": "番茄链接/番茄 JSON 分享卡片", "详情": "识别番茄链接或分享卡片，默认走小说功能内置番茄畅听下载逻辑；完成后上传 UC 网盘并发送“点击打开”按钮，开启番茄API后才走旧番茄API。"},
                ],
            },
            {
                "名称": "群管功能",
