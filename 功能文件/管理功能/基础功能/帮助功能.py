        ...
        "小类": [
            {
                ...
                "触发项": [
                    ...
                    {"名称": "小说开关", "触发": "小说 / 小说列表 / 开番茄 / 开七猫 / 开书旗 / 开QQ阅读 / 开得间 / 开点众 / 开知乎 / 关闭对应功能 / 开测试 / 关测试", "详情": "发送「小说」或「小说列表」可查看全部小说功能的开启/关闭状态；管理员可用「开平台名」或「开启平台名」开启番茄、七猫、书旗、QQ阅读、得间、点众和知乎下载功能。开启管理员测试模式后，管理员可继续测试已关闭的小说平台，普通用户仍按平台开关处理。", "快捷命令": ["小说", "开番茄", "开七猫", "开书旗", "开QQ阅读", "开得间", "开点众", "开知乎", "开测试", "关测试"]},
