...
得间小说功能 = 加载功能模块("功能文件.管理功能.小说功能.得间小说")
点众小说功能 = 加载功能模块("功能文件.管理功能.小说功能.点众小说")
小说缓存清理 = 加载功能模块("功能文件.管理功能.小说功能.下载缓存清理")
    ...
    async def on_all_message(self, event: AstrMessageEvent):
        ...
        if 回复内容 is None:
            ...
            if 得间回复流 is not None:
                if not 小说功能开关.小说功能是否开启("得间", self.config):
            ...
            if 点众回复流 is not None:
                if not 小说功能开关.小说功能是否开启("点众", self.config):
