...
![version](https://img.shields.io/badge/version-v5.58.0-2ea44f)
...
| 追书小说 | 追书神器链接 / 分享卡片 | 自动游客会话、逐章密钥与正文并发请求，完整合成 TXT |
...
- 追书：自动建立追书神器游客会话，复用异步 HTTP 会话并发请求逐章密钥和正文，使用 PyCryptodome 解密完整目录；缺章或解密失败时不生成文件。
