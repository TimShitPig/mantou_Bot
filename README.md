...
![version](https://img.shields.io/badge/version-v5.71.0-2ea44f)
...
| QQ阅读 | 详情/目录/分享链接、Cookie | 自动判断账号 VIP；非 VIP 只走免费明文正文接口，VIP 账号走原账号正文接口，单章付费书只下载免费章节 |
...
- QQ阅读：自动读取详情返回的账号 VIP 状态；非 VIP 账号对筛选后的免费章节使用免费明文正文接口，VIP 账号请求原账号正文接口；免费书下载全量，单章付费书始终只请求免费章节；账号正文每批 200 章、最多 100 路并发，免费正文按最多 200 章分段、最多 16 路并发；支持 Cookie 登录态写入数据库。
