...
| 管理功能 | 书旗小说 | 书旗链接/书旗分享卡片 | 识别书旗长篇/短篇/短链链接；自动获取有效 UID 请求目录，再使用目录返回的 URL 逐章下载，最多 80 个动态并发，单章失败重试 3 次；完成后上传当前选择的小说网盘并发送“点击打开”按钮 |
